                    ...
                    <div className="mt-5 flex items-center justify-between">
                      <div className="flex h-9 items-center border border-black/15">
                        <button
                          ...
                          className="h-full w-9 text-sm text-black/50 hover:text-black"
                        >
                          −
                        </button>
                      ...
                      <button
                        ...
                        className="text-[8px] uppercase tracking-[0.2em] text-black/35 underline-offset-4 hover:text-black hover:underline"
                      >
                        Remove
                      </button>
                    </div>
